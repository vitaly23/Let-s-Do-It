...
public class DigitalItemController {
	...
	public DigitalItemBoundary createNewDigitalItem(@RequestBody DigitalItemBoundary item,
	...
	public DigitalItemBoundary retrieveDigitalItem(@PathVariable("userSpace") String userSpace,
